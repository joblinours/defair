...
pub struct ScanState {
    ...
    /// Sigma: individual events (EVTX records / log lines) evaluated so far.
    pub sigma_events_scanned: AtomicUsize,
...
impl ScanState {
    ...
    pub fn with_cpu_limit(cpu_limit: u8) -> Self {
        Self {
            ...
            sigma_events_scanned: AtomicUsize::new(0),
    ...
    pub fn add_sigma_events(&self, count: usize) {
        self.sigma_events_scanned.fetch_add(count, Ordering::Relaxed);
    }
    ...
    pub fn display_menu(&self) {
        ...
        println!("{}", "                                                        ");
        println!("{}", "                                                        ".on_green());
        println!("{}", "                  RAIJIN INTERRUPT MENU                   ".black().on_green().bold());
        println!("{}", "                                                        ".on_green());
